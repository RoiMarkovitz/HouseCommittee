...
class TenantsElectionsUpdateWindow(BaseView):
    ...
    def update_to_elections(self):
        try:
            cur = Connection.CONN.cursor()
            cur.callproc('update_from_elections',
            ...
            print("update_from_elections procedure executed")
    ...
    def init_widgets(self):
        ...
        topic_label = TopicLabel(topic_frame, text="Update To Elections", size=40).get_label()
        topic_label.pack()
        ...
        button_submit = Button(input_frame, text="Submit", command=self.update_to_elections)
