...
class ServiceProvidersAddWindow(BaseView):
    ...
    def add_to_tenants(self):
        try:
            ...
            cur.callproc('add_service_provider',  [int(self.business_id_stringVar.get()), self.provider_name_stringVar.get(),
            ...
            print("add_service_provider procedure executed")
    ...
    def init_widgets(self):
        ...
        topic_label = TopicLabel(topic_frame, text="Add To Service Providers", size=40).get_label()
        topic_label.pack()
