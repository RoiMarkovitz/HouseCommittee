...
class BalanceWindow(BaseView):
    ...
    def init_widgets(self):
        ...
        # frame that will consist the balance details in the window
        ...
        label_expenses_value = Label(mid_frame, text=str(self.balance[1]), fg="black", bg='lavender',
                                     font=('Ariel', 24))
        ...
        label_balance_value = Label(mid_frame, text=str(self.balance[2]), fg="black", bg='lavender',
                                    font=('Ariel', 24, 'bold'))
