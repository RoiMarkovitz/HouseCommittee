...
class ApartmentPaymentsUpdateWindow(BaseView):
    ...
    def update_apartment_payment(self):
        try:
            ...
            cur.callproc('update_apartment_payment', [int(self.payment_number_stringVar.get()),
                                                      DateUtil.date_converter(self.payment_due_date_stringVar.get()),
                                                      self.payment_reason_stringVar.get(),
                                                      self.first_name_stringVar.get(), self.last_name_stringVar.get(),
                                                      int(self.amount_stringVar.get()), self.payment_method.get(),
