...
class ApartmentsPaymentsReceiptWindow(BaseView):
    ...
    def show_receipt_details(self):
        try:
            ...
            self.label_payment_payer_value['text'] = self.dict_receipt.get('FIRST_NAME') + " " + self.dict_receipt.get(
                'LAST_NAME')
    ...
    def init_widgets(self):
        ...
        # define stringVar for payment number input
        ...
        label_payment_number_name = Label(details_frame, text="Payment Number:", fg="black", bg='lavender',
                                          font=('Ariel', 14))
        ...
        label_payment_due_date_name = Label(details_frame, text="Payment Due Date:", fg="black", bg='lavender',
                                            font=('Ariel', 14))
